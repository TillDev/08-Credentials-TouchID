...
SWIFT_MODULE_NAMESPACE_PUSH("Spruce")
@class NSCoder;

SWIFT_CLASS("_TtC6Spruce6Button")
...
SWIFT_CLASS("_TtC6Spruce14ViewController")
...
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
/// in the <code>viewDidLoad</code> method all of the views are prepared for animation
- (void)viewDidLoad;
/// a simple overrided method that will call <code>spruce_up</code> on the <code>animationView</code>. If the <code>animationView</code> is not set then nothing will happen. The code should silently fail.
